...
and the sources inlined below each one carry the citations. A further 24
...
24 more companion pages landed on 2026-09-05, each independently
...
| Replit Agent | No skills/rules-directory convention; automatically reads `replit.md` at project root — append the policy there | `site/replit.html` |
