...
- **Status:** available now — starts with a trial of the full Pro bundle. Enter your email at https://getundercut.sh/#pricing ("Start your Pro trial") and sign-in details follow by email; nothing is charged during the trial
...
- Pro starts from the pricing card: enter an email, sign-in details follow, and the trial runs on the full bundle before the first charge. Teams is bought through founder-handled onboarding — there is no self-serve Teams checkout; billing is set up on the onboarding call, and the page says so.
