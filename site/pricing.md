...
- **Includes:** everything in Pro, for every seat — the same feature bundle, not a different one — plus a shared team dashboard, org-wide tier policy enforcement, and seat management; SSO/directory sync and an audit log are a stretch goal, not promised; email support, onboarding run by the founder
