...
- **Status:** live now
- **Includes:** the full six-flag rubric and escalation ladder as an MIT-licensed SKILL.md; works with Claude Code, Codex, Cursor, Copilot, OpenCode; audit/fork/keep forever; community support via GitHub issues
...
- Pricing and feature scope for Teams/Enterprise are the current build target, not a signed rate card — they may firm up before launch.
